...
const PROACTIVE_PROMPT = [
  ...
  '- SKILLS: below is a catalog of specialised skills you can use. When a',
  '  request matches one, call the load_skill tool with its id FIRST to load its',
  '  full instructions, then follow them. Load a skill before doing specialised',
  '  work; for ordinary questions, just answer directly without loading anything.',
