...
async function refreshTasks(userId) {
  ...
  manualC.forEach(function (c) { jobs.push(runOne('manual', 'manual-task-extract', c)); });
  ...
  return { email: emailC.length, whatsapp: waC.length, monday: mondayCtx.count, manual: manualC.length };
}
